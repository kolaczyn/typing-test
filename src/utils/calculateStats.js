...
export const calculateGrossWpm = (typedCharacters, time) =>
  time ? typedCharacters / 5 / time : 0;

export const calculateNetWpm = (typedCharacters, time, uncorrectedErrors) =>
  time
...
export const calculateAccuracy = (correctCharacters, totalCharacters) =>
  totalCharacters ? Math.round((correctCharacters / totalCharacters) * 100) : 0;
